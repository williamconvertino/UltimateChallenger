...
public class PlayerCollider : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        _playerColliderHitbox.transform.position = parentCollider.transform.position;
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        if (otherPlayer != null && otherPlayer.CompareTag("PlayerCollider"))
        {
            ChallengePlayerScript[] challengeScripts = otherPlayer.GetComponents<ChallengePlayerScript>();
